...
public class TipoRendaModel {
    ...
    public TipoRendaModel() {
    }

    public TipoRendaModel(String descricao, Integer vigente) {
    ...
    public boolean equals(Object o) {
        ...
        TipoRendaModel tipoRenda = (TipoRendaModel) o;
        return Objects.equals(id, tipoRenda.id);
    }
